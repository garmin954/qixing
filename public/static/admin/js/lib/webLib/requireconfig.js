...
requirejs.config({
    paths: {
        ...
        scrollreveal: 'https://cdn.bootcss.com/scrollReveal.js/4.0.0-beta.24/scrollreveal.min',
        ...
        Vee: 'https://cdn.bootcss.com/vee-validate/2.0.0-rc.25/vee-validate.min',

        VeeCn: "https://cdn.bootcss.com/vee-validate/2.0.0-rc.25/locale/zh_CN",
        ...
        // vue组件
        component: "component/vuecomponent/component",
    ...
    shim: {
        ...
        wangEditor:['css!https://cdn.bootcss.com/wangEditor/10.0.13/wangEditor.min.css'],
