...
function dTree(objName) {
    ...
    this.icon = {
        root: '/public/static/vendor/tree/img/base.gif',
        folder: '/public/static/vendor/tree/img/folder.gif',
        folderOpen: '/public/static/vendor/tree/img/folderopen.gif',
        node: '/public/static/vendor/tree/img/page.gif',
        empty: '/public/static/vendor/tree/img/empty.gif',
        line: '/public/static/vendor/tree/img/line.gif',
        join: '/public/static/vendor/tree/img/join.gif',
        joinBottom: '/public/static/vendor/tree/img/joinbottom.gif',
        plus: '/public/static/vendor/tree/img/plus.gif',
        plusBottom: '/public/static/vendor/tree/img/plusbottom.gif',
        minus: '/public/static/vendor/tree/img/minus.gif',
        minusBottom: '/public/static/vendor/tree/img/minusbottom.gif',
        nlPlus: '/public/static/vendor/tree/img/nolines_plus.gif',
        nlMinus: '/public/static/vendor/tree/img/nolines_minus.gif'
    };
    this.obj = objName;
    this.aNodes = [];
    this.aIndent = [];
    ...
    if(cshow.search('@yl') != -1 ){
        cshow= cshow.replace('@yl','');
        cshow = cshow+"</a>&nbsp;<a href=\"javascript:;\" data-id=\""+id+"\"  onclick=\"yladdNode(this)\"><i class=\"layui-icon\">&#xe654;</i>" +
            "</a>&nbsp;<a href=\"javascript:;\" data-id=\""+id+"\"  onclick=\"yleditNode(this)\"><i class=\"layui-icon\">&#xe614;</i>" +
            "</a>&nbsp;<a href=\"javascript:;\" data-id=\""+id+"\"  onclick=\"member_del(this,"+id+")\"><i class=\"layui-icon\" style=\"color:black;\">&#xe640;</i>";
    }
    }
...
dTree.prototype.indent = function (node, nodeId) {
    ...
    if (this.root.id != node.pid) {
        ...
        if (node._hc) {
            ...
            if (!this.config.useLines) str += (node._io) ? this.icon.nlMinus : this.icon.nlPlus; else str += ((node._io) ? ((node._ls && this.config.useLines) ? this.icon.minusBottom : this.icon.minus) : ((node._ls && this.config.useLines) ? this.icon.plusBottom : this.icon.plus));
            str += '" alt="" /></a>';
